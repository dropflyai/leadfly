              ...
              <SignIn 
                ...
                appearance={{
                  elements: {
                    ...
                    socialButtonsBlockButton: "bg-white hover:bg-gray-50 text-gray-700 border border-gray-300 w-full group flex items-center justify-center space-x-3 px-4 py-4 rounded-xl font-semibold transition-all duration-300 shadow-sm hover:shadow-md",
